...
This survey focuses on health and ecinomic impacts of natural disasters. It is based on National Weather Service Storm Data and its goal is to answer two questions:
...
On two following plots top-10 event with highest death and injuries rate are show:
...
As we can see, tornados are the most dangerous disasters for people.

Next let's take a look at plot of top-10 events with highest ecinomis impact:
